(function () {
    ...
    var socketObject = {
        sid: sid,
        type: "action_scheme_for_edit_additional_service_group",
        ...
        load: {
            command: "get",
            object: "action_scheme_for_edit_additional_service_group",
            params: {
...
//                                        '<i class="fa fa-angle-double-up"></i>' +
        ...
        addGroup: function(wrap, cb){
            ...
            var o = {
                command: 'new',
                object: 'action_scheme_additional_service_group', //additional_service_group
                params: {
                    action_id: contentInstance.activeId,
                    name: title,
                    color: color
...
//            console.log(pg.places);
        ...
        save: function(){
            ...
            var o = {
                command:"operation",
                object:"modify_action_scheme_item",
                params:{
                    action_scheme_id: ids.join('|!|'),
