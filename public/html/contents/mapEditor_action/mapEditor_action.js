...
function mapEditor_action_init(id){
    ...
    mapEditor_map.container.on('modifyAreaGroup',function(e,objects){
        mapEditor_map.modifyAreaGroupServer(objects);
    });
    ...
    mapEditor_map.container.on('removeSquare',function(e,square_ids){
        ...
        mapEditor_map.removeSquaresClient(square_ids);
        $(document).trigger('deleteSquares',[square_ids]);
    ...
    var renderObjects = [];
        mapEditor_map.container.trigger('loadLayer',[{},function(result){
            ...
            for (var l in obj){
                ...
                mapEditor_map.container.trigger('loadObject',[{layer_id:obj[l].HALL_SCHEME_LAYER_ID},function(result2){
                    counter2++;
