(function () {
    var instance = MB.O.forms["form_order_realization"];
                            ...
                            ok: {
                                ...
                                callback: function () {
                                    MB.Core.sendQuery({
                                        ...
                                        sid: MB.User.sid,
                                        params: {ORDER_ID: orderId, DISCOUNT: $(".orderDiscount").val()}
                                    }, function (data) {
                                        if (data.RC == 0) {
...
//                                                }
            ...
            var buttons = {
                ...
                "deliverynoteorderXML": {
                    html: "<button type='button' id='btn_deliverynoteorderXML' class='btn purple-stripe custombutton deliverynoteorderXML'><i class='fa fa-credit-card'></i> Накладная на выдачу XML</button>",
                    callback: function () {
                        var o = {
                            output_format: "xml",
                            command: "get",
            ...
            $(".form_order_realization-content-wrapper").html("");
            var table = new MB.Table({
                world: "form_order_realization",
                name: "tbl_order_ticket_realization",
                params: {
                    parent: instance
            ...
            instance.$container.find("a[href='#orderhistory']").off().on("click", function (e) {
                $(".form_order_realization_2-content-wrapper").html("");
                log(instance)
                var table = new MB.Table({
                    world: "form_order_realization_2",
            ...
            console.log((function () {
                var d = new Date();
                return 'END' + d + d.getMilliseconds()
            }()))
        });
    };
})();