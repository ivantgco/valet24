...
var App = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        var content = $("#page_" + MB.User.activepage + "_wrapper");
        // var content = $("#page_content_index_wrapper");
    ...
    var handleAccordions = function () {
        ...
        jQuery('body').on('show.bs.collapse', '.accordion.scrollable', function () {
            console.log('removed scrollTop animation');
            return;
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "metronic/admin/template_content/assets/css/themes/" + color_ + ".css");
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
                message: '<img src="metronic/admin/template_content/assets/img/ajax-loading.gif" align="">',
