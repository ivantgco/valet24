...
socket.on('error', function (data) {
	var connectPath = 'barvikha.multibooker.ru';
	var localPath = '192.168.1.190';
	if (location.host == localPath || location.hostname == 'localhost') {
		connectPath = localPath;
	}
